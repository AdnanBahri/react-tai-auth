  ...
  return (
    <div className="w-full h-screen flex items-center justify-center">
      <button
        ...
        className="flex items-center justify-center space-x-4 bg-slate-900 py-2 w-40 rounded-md shadow-sm hover:shadow-md text-white text-md font-semibold"
      >
        {loading && (
          <svg
            aria-hidden="true"
            className="w-4 h-4 mr-2 text-white animate-spin dark:text-gray-600 fill-slate-900"
            viewBox="0 0 100 101"
            fill="none"
